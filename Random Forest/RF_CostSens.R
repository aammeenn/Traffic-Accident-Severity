...
RFCV = function(train, val) {
  ...
  ntree = 100;
  set.seed(1)
  RF = randomForest(Severity~., data = train, mtry = mtry, ntree = ntree, classwt = c(1,5), replace = FALSE);
...
# CART original
RFCostSens = CalculateCV(set2345,set1345,set1245,set1235,set1234,set1,set2,set3,set4,set5);